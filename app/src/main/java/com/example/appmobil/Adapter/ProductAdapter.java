...
public class ProductAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView onorder = vi.findViewById(R.id.txtonorder);
        onorder.setText(Integer.toString(item.getQyor()));
        TextView pres =  vi.findViewById(R.id.pres);
        pres.setText(item.getPres());
    return vi;
    }
}
